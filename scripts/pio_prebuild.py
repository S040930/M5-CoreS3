...
CONFIG_MAP = {
    ...
    "sedentary.enabled":                  ("CONFIG_SEDENTARY_ENABLE", _bool_y),
    "sedentary.capture_interval_sec":   ("CONFIG_SEDENTARY_CAPTURE_INTERVAL_SEC", _int_str),
    "sedentary.remind_after_sec":       ("CONFIG_SEDENTARY_REMIND_AFTER_SEC", _int_str),
    "sedentary.absence_reset_sec":      ("CONFIG_SEDENTARY_ABSENCE_RESET_SEC", _int_str),
    "sedentary.repeat_interval_sec":    ("CONFIG_SEDENTARY_REPEAT_INTERVAL_SEC", _int_str),
    "sedentary.detect_fail_suspend_count": ("CONFIG_SEDENTARY_FAIL_SUSPEND_COUNT", _int_str),
    "sedentary.suspend_cooldown_sec":   ("CONFIG_SEDENTARY_SUSPEND_COOLDOWN_SEC", _int_str),
    "sedentary.camera.xclk_gpio":       ("CONFIG_SEDENTARY_CAM_XCLK_GPIO", _int_str),
    "sedentary.voice_prompt":           ("CONFIG_SEDENTARY_VOICE_PROMPT", _quoted),
    "sedentary.local.present_threshold": ("CONFIG_SEDENTARY_LOCAL_PRESENT_THRESHOLD", _int_str),
    "sedentary.local.absent_threshold": ("CONFIG_SEDENTARY_LOCAL_ABSENT_THRESHOLD", _int_str),
    "sedentary.local.present_confirm_count": ("CONFIG_SEDENTARY_LOCAL_PRESENT_CONFIRM_COUNT", _int_str),
    "sedentary.local.absent_confirm_count": ("CONFIG_SEDENTARY_LOCAL_ABSENT_CONFIRM_COUNT", _int_str),
    "sedentary.local.roi_margin_px":    ("CONFIG_SEDENTARY_LOCAL_ROI_MARGIN_PX", _int_str),
