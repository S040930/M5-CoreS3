...
**M5Stack CoreS3 only. AirPlay 1 playback core with local status screen UI. No cloud, no USB/HTTP management surface.**
...
默认产品**不再包含**触屏配网、USB Web Serial 管理、HTTP 管理页、SPIFFS Web 资产、OTA、诊断流、SoftAP、以太网、蓝牙、外部 DAC、按钮/灯效控制，以及触摸驱动的播放控制语义。
